...
class QuranPageKeepAlive extends StatefulWidget {
  const QuranPageKeepAlive({required this.child, super.key});
  final Widget child;
  @override
  State<QuranPageKeepAlive> createState() => _QuranPageKeepAliveState();
}

class _QuranPageKeepAliveState extends State<QuranPageKeepAlive>
