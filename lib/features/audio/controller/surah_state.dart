...
class SurahState {
  ...
  StreamSubscription<Duration>? surahPositionSubscription;
  ...
  Future<Directory> get dir async {
    if (!kIsWeb) {
      return dirCache ??= await getApplicationDocumentsDirectory();
    }
  ...
  void cancelAllSubscriptions() {
    ...
    surahPositionSubscription?.cancel();
    playerStateSubscription = null;
    currentIndexSubscription = null;
    surahPositionSubscription = null;
  }
